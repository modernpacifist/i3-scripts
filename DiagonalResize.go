...
func resize(resizeValue int) {
	...
	i3.RunCommand(fmt.Sprintf("move container left %d px", resizeValue/2, resizeValue/2))
	i3.RunCommand(fmt.Sprintf("move container up %d px", resizeValue/2, resizeValue/2))
}
